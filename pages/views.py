...
class ProductShowView(View):
    ...
    def get(self, request, id):
        try:
            product_id = int(id)
            if product_id < 1:
                raise ValueError("Product id must ve 1 or greater")
        ...
        viewData["subtitle"] = product.name + " - Producdt information"
...
class ProductCreateView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            return render(request, "products/product_created.html", viewData)
        else:
            viewData = {}
            viewData["title"] = "Create product"
            viewData["form"] = form
